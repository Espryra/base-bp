...
export const custom_content = {
  ...
  //     type: "item",
  //   },
} as Record<string, { texture: string; type: "item" | "block" }>;
...
// Define the type for the CHEST_UI_SIZES map
export const CHEST_UI_SIZES: Map<string | number, [string, number]> = new Map<
  string | number,
  [string, number]
>([
